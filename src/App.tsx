...
export default function App() {
  ...
  const everyLanguage = ['인정하는 말', '함께하는 시간', '선물', '봉사', '스킨십'] as const;
  type Language = (typeof everyLanguage)[number];
  ...
  const detailContent: Record<Language, ReactNode> = {
    '인정하는 말': (
      <>
        <p>
        ...
        <p>
          또한 친절한 행동에 감사를 표현해 주길 바랍니다. 가족의 경우는 '표현하지 않아도 감사한
          마음을 다 알아주겠지'라는 생각때문에 당연한 행동인 듯 무반응일 때가 있습니다. 작은 일에도
          고마움을 표현해 주는 것이 필요합니다. 이들에게 격려의 말은 용기를 북돋아주고 안정감을
          줍니다. 무언가를 부탁할 때도 정중하게 표현하게 되면 자신을 인격과 능력을 인정한다고
          생각합니다. 반대로 누구나 인정하는 말을 좋아하지만 특히 '인정하는 말'이 사랑의 언어인
          사람은 상대방이 무심코 던진 말이 큰 상처가 되고 아파할 수 있다는 것을 알아야 합니다.
        </p>
        <p>
          말이 중요하다는 것 잊지마세요. 뜻 밖의 전화 한통, 진심이 담긴 카드나 메모도 좋고 카톡도
          좋습니다. 사랑을 표현하는 말을 자주 해주세요. 부정적이고 비판적인 말, 명령, 욕설, 영혼
          없는 말은 평생 동안 기억에 남아 자존감에도 영향을 끼칠 수 있답니다.
        </p>
      </>
    ),
    '함께하는 시간': (
      <>
        <p>
          서로에게 집중하여 함께 있는 시간을 많이 가져야 사랑 받는 닫고 느낍니다. 함께 시간을
          나누면서 하는 일이 무엇인지는 별로 중요하지 않습니다. 다만 함께 시간을 보내는 사람이
          소중하고 그 사람과 시간을 공유하지 못하면 애정결핍을 느끼게 됩니다. 따라서 본인을 위해
          온전히 시간을 집중해 주는 것을 최고의 사랑으로 생각하기 때문에 함께 있어주는 것이 가장
          중요합니다.
        </p>
        <p>
        ...
        <p>
          ...
          것을 원하고 함께하는 행동에 의미를 둡니다. 특별한 순간을 만들면 오래 행복감을 느끼고
          진정한 대화를 원합니다. 대화를 할때 딴 짓을 하거나 객관적인 비판을 하는 것은 좋지
          않습니다.
        </p>
      </>
    ),
    선물: (
      <>
        <p>
          상징적인 의미를 지닌 물건을 통해 사랑을 확인 받는 사람들입니다. 상대방이 준 선물을
          특별하게 기억하고 간직하기 때문에 선물을 주고 받는 것을 좋아합니다.
        </p>
        <p>
          '선물'이 사랑의 언어를 물질주의 속물근성과 혼돈하지 않아야 합니다. 이 사람은 선물에
          담겨있는 사랑과 사려 깊음 선물을 준비하기 까지의 관심과 노력을 소중하게 생각하는 것입니다.
          선물은 "당신을 소중하게 여기고 배려하는 마음"이 담겨 있기 때문이죠. 따라서 생일이나
          결혼기념일 등 의미있는 날을 잊거나 성의 없이 준비한 선물은 오히려 큰 상처가 될 수
          있습니다.
        </p>
        <p>
          굳이 비싼 선물을 나눌 필요는 없습니다. 선물을 통해 생각하는 마음이 담겨있는 선물을
          전달하는 것이 중요합니다.
        </p>
        <p>
          ...
          잊어버리거나 영혼없이 준비한 선물, 받고도 무반응인 모습은 상처가 될 수 있다는 걸
          기억하세요.
        </p>
      </>
    ),
    봉사: (
      <>
        <p>
          ...
          설겆지 청소 등육아나 가사일을 해주것, 아플 때 다른 사람을 돌보는 것 등 노력과 수고가
          필요한 일을 해주는 것이 해당됩니다. 행동하는 것을 의사 소통하는 수단으로 생각하는 거죠.
        ...
        <p>
          "뭐 도와줄 거 없어?" "그거 내가 해줄께" 상대방을 도와주는 것이 기쁘고, 상대방이 가장
          원하는 것을 해주는 행동이 사랑을 표현하는 것이라 생각합니다. 따라서 게으름을 피우거나 약속
          위반을 하는 것은 이 언어를 사용하는 사람들에게 심각한 일일 수 있죠. 시켜야 하는 행동이나
          하고나고 생색을 내는 것은 좋지 않겠죠.
        </p>
      </>
    ),
    스킨십: (
      <>
        ...
        <p>
          ...
          감정이 느껴진 적 있으시죠. 아무 말 없이 살며시 안아주고 등을 두드려주는 것만으로도
          상대방의 마음이 전해집니다. 포옹이나 등 두드리기, 손잡기, 어깨나 팔, 얼굴 등을 만지는 것을
          통해 자신의 감정을 표현하는 것을 좋아하고 받는 것을 좋아하는 타입입니다.
        </p>
        <p>
    ...
    <>
      <main>
        {result ? (
          <section className='result'>
            ...
            {detailModal && (
              <div className='detail' style={{ zIndex: '9' }}>
                <div>
                  <div>
                    <h3>{detailModal}</h3>
                    <hr style={{ margin: '1rem 0' }} />
                    <div>{detailContent[detailModal]}</div>
                  </div>
                  <div
                    style={{
      ...
      <footer>
        <h5>
          ...
          >
            Reference: 5가지 사랑의 언어 테스트, 당신의 사랑의 언어는?
          </div>
        </h5>
      </footer>
    </>
